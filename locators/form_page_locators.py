...
class FormPageLocators:
    ...
    GENDER = (By.CSS_SELECTOR, f"div[class*='custom-radio'] label[for='gender-radio-{random.randint(1,3)}']")
    ...
    HOBBIES = (By.CSS_SELECTOR, f"div[class*='custom-checkbox'] label[for='hobbies-checkbox-{random.randint(1,3)}']")
